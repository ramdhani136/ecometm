...
function ListPromoComponent({ img, name, price, prevprice }) {
    ...
    return (
        ...
        <div className="containerList">
            ...
            <div style={{ textDecoration: 'line-through gray', fontWeight: 400, marginTop: '0px', marginLeft: '10px', marginRight: '10px', fontFamily: 'calibri', color: 'gray', fontSize: '1.05em' }}>{prevprice}</div>
